...
% Additionally, this project has been a great
% opportunity to continue developing my skills in mathematical optimization; a discipline which not
% only has its own problems
...
% \end{aligned} \]
% \[\begin{aligned}
%     p_{P}(k) = &\left( \mathbf{Prob}\left(y_N = k_n \mid y_{N-1} = k_{n-1}, \ldots, y_1 = k_1\right) \right) \\
%     &\left( \mathbf{Prob}\left(y_{N-1} = k_{n-1} \mid y_{N-2}=k_{n-2}, \ldots, y_1 = k_1 \right) \right) \\
%     &\cdots \left( \mathbf{Prob}(y_{2} = k_{2} \mid y_{1} = y_{1}) \mathbf{Prob}\left(y_1 = k_1\right) \right) ,
% \end{aligned}\]
\[\begin{aligned}
